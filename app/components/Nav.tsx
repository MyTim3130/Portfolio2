...
const Nav = () => {
  ...
  return (<section className='w-screen h-[5vh] flex justify-between items-center fixed z-50'>
    ...
    <div className='w-2/6 hidden justify-evenly  sm:flex'>
        ...
        <span className='hover:cursor-pointer' onClick={()=>gsap.to(window, {duration: 0, scrollTo: 6250 })}>Skills</span>  
        <span className='hover:cursor-pointer' onClick={()=>gsap.to(window, {duration: 0, scrollTo: 9000 })}>Contact Me</span>  
